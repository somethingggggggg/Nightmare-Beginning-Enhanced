...
image_speed=0.16
if global.hardmode=1{image_speed=0.25}
Hit=1
Grav=1
Move=1
Shell=0
...
if vspeed = 0
{
if sprite_index=sprKoopa1{
if global.hardmode=0{hspeed = image_xscale*0.9}
if global.hardmode=1{hspeed = image_xscale*2.5}}
if sprite_index=sprKoopa2{
if global.hardmode=0{hspeed = image_xscale*5.5}
if global.hardmode=1{hspeed = image_xscale*10}}

if !place_meeting(x+25,bbox_bottom+5,Solid_Mask) && image_xscale = 1
{
image_xscale=-1
}
...
sound_play(global.S_Stomp);Hit=1.5;Move=0;hspeed=0;vspeed=0;sprite_index=sprKoopa2;image_index=0;image_speed=0;alarm[2]=35
...
if AllPers.ground=1 && AllPers.image_alpha=1{playerGetHit()}}}
...
if Hit=2{
if GOD_LEVEL.JumpMode=1 or GOD_LEVEL.SpindashMode=1{
if sprite_index=sprKoopa2{Hit=2.5;alarm[3]=35;Move=1;image_speed=0.3
AllPers.vspeed=-3}}

if (GOD_LEVEL.JumpMode=0 && hspeed!=0) && GOD_LEVEL.SpindashMode=0{
