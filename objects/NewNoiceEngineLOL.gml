...
{
    if global.hardmode = 0 draw_sprite_tiled(sprite_index,image_index,287,166)
    else draw_sprite_tiled_ext(sprite_index,image_index,287,166,1,1,image_blend,1)
}
else
{
    if global.hardmode = 0 draw_sprite(sprite_index,image_index,view_xview[0]+287,view_yview[0]+166)
