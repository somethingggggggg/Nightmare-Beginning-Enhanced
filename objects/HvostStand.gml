...
if Tails4.sprite_index = sprTailsWalk or Tails4.sprite_index = sprTailsRun or Tails4.sprite_index = sprTailsJump or Tails4.sprite_index = sprTailsRacing or Tails4.sprite_index = sprTailsRacingTired
{
image_alpha = 0
}

if Tails4.sprite_index != sprTailsWalk && Tails4.sprite_index != sprTailsRun && Tails4.sprite_index != sprTailsJump && Tails4.sprite_index != sprTailsRacing && Tails4.sprite_index != sprTailsRacingTired
{
image_alpha = 1
}
...
if instance_exists(DM_Tails) && DM_Tails.image_xscale = -1
{
image_xscale = -1
move_snap(DM_Tails.x+5,DM_Tails.y+4)
}

if DM_Tails.sprite_index = sprTailsWalk or DM_Tails.sprite_index = sprTailsRun or DM_Tails.sprite_index = sprTailsJump or DM_Tails.sprite_index = sprTailsRacing or DM_Tails.sprite_index = sprTailsRacingTired or DM_Tails.sprite_index = sprTailsSpindash
{
image_alpha = 0
}

if DM_Tails.sprite_index != sprTailsWalk && DM_Tails.sprite_index != sprTailsRun && DM_Tails.sprite_index != sprTailsJump && DM_Tails.sprite_index != sprTailsRacing && DM_Tails.sprite_index != sprTailsRacingTired && DM_Tails.sprite_index != sprTailsSpindash
{
image_alpha = 1
}
