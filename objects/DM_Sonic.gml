...
if ground == true && ducking == false && rolling == false && spindash == false && Idie_mode = false
{
   if global.vel == 0
{
sprite_index = sprHyperSonic
image_speed = 0.2
}
else if global.vel > -8 && global.vel < 8
   sprite_index = sprHyperSonicWalk;
else
   sprite_index = sprHyperSonicRun;
{
image_speed = 0.2
}}
else if sprite_index == sprHyperJump
{
...
if ducking == true && spindash == false
{
   sprite_index = sprHyperSonicDuck;
if image_index < 1
   image_speed = 0.2;
else
   image_speed = 0;
...
//Ducking animation in the air fix
if ground == false && sprite_index == sprHyperSonicDuck
   sprite_index = sprHyperJump;
