...
applies_to=self
*/
with ExetiorBonusPass
{
    Act=1;
    sprite_index=sprExetiorP_Win;
    vspeed=-6;
    image_speed=0;
    image_index=0;
    hspeed=1.5
...
if Act = 0
{
    ...
    if !instance_exists(ExetiorBonus) instance_create(6464,396,CharBonusPass)
    else instance_create(6480,396,ExetiorBonusPass)
    Functions.Track=3
