...
spritedial = 0
scr_hackdialget()
screen_save(working_directory+"hackery_fuckery.png")
sprite_replace(spr_hackerycontin,working_directory+"hackery_fuckery.png",0,0,0,0,0)
...
draw_text_ext_color(view_xview[0]+100, view_yview[0],message,16,362,$00ffff,$00ffff,$00ffff,$005555,1)
