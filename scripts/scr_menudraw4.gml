...
repeat(ds_list_size(fuckarr))
{
    ...
    {
        if suka+1 != global.option draw_text(view_xview[0]+view_wview[0]/2,view_yview[0]+((suka+2)*8)+scroll,ds_list_find_value(fuckarr,suka))
        else draw_text_color(view_xview[0]+view_wview[0]/2,view_yview[0]+((suka+2)*8)+scroll,ds_list_find_value(fuckarr,suka),$00ffff,$00ffff,$00ffff,$005555,1)
    }
    suka += 1
}
