...
switch global.option
{
    ...
    break;
    case 2:
        if global.cheats = 0 or room = 38 draw_text_color(view_xview[0]+view_wview/2-string_width("quit game")/2,view_yview[0]+view_hview[0]/2+64-string_height("quit game")/2,"quit game",$00f6ff,$00f6ff,$00f6ff,$00f6ff,1)
        else draw_text_color(view_xview[0]+view_wview/2-string_width("lvl select")/2,view_yview[0]+view_hview[0]/2+64-string_height("lvl select")/2,"lvl select",$00f6ff,$00f6ff,$00f6ff,$00f6ff,1)
    break;
}
