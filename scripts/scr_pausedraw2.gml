...
if global.performance = 0 draw_sprite_stretched_ext(sprpausefuck,0,view_xview[view_current],view_yview[view_current],view_wview[view_current]+abs(global.performance-1)/2,view_hview[view_current]+abs(global.performance-1)/2,c_white,1)
