...
while i < menulength[global.suboption]
{
    ...
    if string_width(optionname[i,global.suboption]) > 148/*112*/ draw_text_ext_transformed(32+view_xview[view_current]+HorizScroll,55+view_yview[view_current]+scroll+(i*10+30),optionname[i,global.suboption],0,1000,148/string_width(optionname[i,global.suboption]),1,0)
    else draw_text(32+view_xview[view_current]+HorizScroll,55+view_yview[view_current]+scroll+(i*10+30),optionname[i,global.suboption])
    draw_set_halign(fa_right)
    if optionVarName[i,global.suboption] != "voicedir"
    {
        if string_width(variable_local_array2_get("optionstate"+string(global.suboption+1),i,variable_global_get(optionVarName[i,global.suboption]))) > 80/*64*/ draw_text_ext_transformed(234+view_xview[view_current]+HorizScroll,55+view_yview[view_current]+scroll+(i*10+30),variable_local_array2_get("optionstate"+string(global.suboption+1),i,variable_global_get(optionVarName[i,global.suboption])),0,1000,80/string_width(variable_local_array2_get("optionstate"+string(global.suboption+1),i,variable_global_get(optionVarName[i,global.suboption]))),1,0)
        else draw_text(234+view_xview[view_current]+HorizScroll,55+view_yview[view_current]+scroll+(i*10+30),variable_local_array2_get("optionstate"+string(global.suboption+1),i,variable_global_get(optionVarName[i,global.suboption])))
    }
    else
    {
        if ds_list_find_value(global.voicelist,global.voicedir) != ''
        {
            if string_width(string_copy_end(ds_list_find_value(global.voicelist,global.voicedir),string_length(ds_list_find_value(global.voicelist,global.voicedir))-6)) < 64 draw_text(234+view_xview[view_current]+HorizScroll,55+view_yview[view_current]+scroll+(i*10+30),string_copy_end(ds_list_find_value(global.voicelist,global.voicedir),string_length(ds_list_find_value(global.voicelist,global.voicedir))-6))
            else draw_text_ext_transformed(234+view_xview[view_current]+HorizScroll,55+view_yview[view_current]+scroll+(i*10+30),string_copy_end(ds_list_find_value(global.voicelist,global.voicedir),string_length(ds_list_find_value(global.voicelist,global.voicedir))-6),0,1000,64/string_width(string_copy_end(ds_list_find_value(global.voicelist,global.voicedir),string_length(ds_list_find_value(global.voicelist,global.voicedir))-6)),1,0)
        }
        else
        {
            draw_text(234+view_xview[view_current]+HorizScroll,55+view_yview[view_current]+scroll+(i*10+30),'off')
        }
    }
...
if global.option > 1
{
    if optionblocked[global.option-2,global.suboption] = 0 draw_text_ext(346+view_xview[view_current],163+view_yview[view_current],optiondesc[global.option],8,192)
