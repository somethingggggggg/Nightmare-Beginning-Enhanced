...
with AllPers
{
    ...
    or sprite_index=sprHyperJump or sprite_index=sprMS_Jump or sprite_index=sprFinalExe_Jump
    {
        return 1;
    }
    else if sprite_index=sprTailsSpindash or sprite_index=sprKnucklesSpindash or sprite_index=sprSonicSpindash or sprite_index=sprHyperSpindash or sprite_index=sprMS_Spindash or sprite_index=sprSonicSpindash
    {
        return 1;
    }
    else return 0;
